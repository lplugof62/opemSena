...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <form action="CreacionAdmin.jsp" method="POST" class="login" onSubmit="return validarfor();">
            <fieldset>
            <img src="img/Logo.jpg" id="miImagen" width="350" height="100">
            <h3 class="text-center">Creacion Usuario Admin</h3>
           ...
           <input type="text" name="txtCorreo" id="txtCorreo" placeholder="Escriba su correo Electronico"></input> 
            ...
            <p class="text-center">
                ...
                <input  type="button"  class="btn btn-primary btn-block" name="BotonRegresoLogin" value="Volver al Menu" onclick="redirect();"></input> 
            </p>
            </fieldset>
        </form>
   ...
   ventana.document.open();
        ...
        function redirect(){
        window.location.replace('http://localhost:8084/OPEMSENA1/IndexMain.jsp'); 
       }
